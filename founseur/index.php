<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
      if(isset($_POST['connexion']))
      {
        ...
        $stmt=$con->prepare("select id_u,username,password from users where username=? and password=? and status=2 and sup=0 LIMIT 1");
...
<form class="login" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        <h4 class="text-center">Magasinier connexion</h4>
